/* ==========================================================================
   ...
   do título dos módulos/cards expandidos.
   ========================================================================== */

/* Contêiner do Título - Formato Tiles */
body[id*="page-course-view-"][id*="-tiles"] .sectiontitle {
...
/* Texto do Título (H2) - Formato Tiles */
body[id*="page-course-view-"][id*="-tiles"] .sectiontitle h2 {
